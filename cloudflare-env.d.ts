/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: f3034782a10f45dde69a81c259a080b7)
...
declare namespace Cloudflare {
	interface Env {
		...
		ASSETS: Fetcher;
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* syntax3d */;
	}
}
